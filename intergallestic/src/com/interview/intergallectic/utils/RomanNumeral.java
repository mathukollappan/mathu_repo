package com.interview.intergallectic.utils;
...
public class RomanNumeral {
	...
	private static int[] numbers = {1000, 900, 500, 400, 100, 90, 50, 40, 10, 9,
			5, 4, 1};
	...
	public String getRomanString(int arabic)
	{
	...
	/*public static void main(String[] args) {
		for(int i = 1; i <= 3999; ++i){
			System.out.println(new RomanNumeral(i).toString());
		}
	}*/
}
